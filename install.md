# colombia jobs guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `colombia_jobs/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `colombia_jobs` folder and use the modules inside your notebooks :
...
```python
from colombia_jobs.utils.paths import data_dir
data_dir()
```
